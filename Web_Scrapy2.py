...
class Scrapy():
    ...
    def __init__(self):
        ...
        #self.boards=simple.config3.obj.boards()
    ...
    #             url = "https://rolls-royce.leankit.com/Account/Membership/Authenticate?support=False"
                ...
                for i in board_no:
                    ...
                    cards2 = cards1.text
                    print(cards2)
                    # print("We are here" + cards2)
                    listofcards = []
                    card_Nos = {}
                    card_Nos = json.loads(cards2)
                    # print("We are here" + str(json.loads(cards2)))
                    # print("We are here"+ str(card_Nos))
                    #print("We are here" + card_Nos)
                    print("Next: ")
                    print(card_Nos)
                    asd = card_Nos ['cards']
                    print(asd)
